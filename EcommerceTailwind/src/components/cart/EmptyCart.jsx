  ...
  return (
    <>
      <div className='flex flex-col px-11 justify-center items-center text-center h-screen gap-7'>
        ...
        />
        <button className='button-theme bg-gradient-to-b from-amber-500 to-orange-600 shadow-lg shadow-orange-500 text-sm font-semibold flex justify-center items-center gap-3 px-4 py-2 active:scale-110 text-slate-900 transition-all duration-300'>
